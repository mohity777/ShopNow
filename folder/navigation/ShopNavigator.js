...
const StackScreen1 = () => {
  return (
    <Stack1.Navigator screenOptions={defaultNavigationOptions}>
      <Stack1.Screen
    ...
    <Stack3.Navigator screenOptions={defaultNavigationOptions}>
      <Stack3.Screen
        ...
        options={({navigation, route}) => ({
          ...
          headerRight: () => (
            <TouchableOpacity
              onPress={() => navigation.navigate('UserEdit', {id: undefined})}>
              <Micon
                style={{marginRight: 15}}
                size={25}
                color="white"
    ...
    <NavigationContainer>
      <Drawer.Navigator
        ...
        <Drawer.Screen
          ...
          options={{
            drawerIcon: ({color}) => (
              <Dicon name="home" size={23} color={color} />
            ),
          }}
        />
        <Drawer.Screen
          ...
          options={{
            drawerIcon: ({color}) => (
              <Dicon name="reorder" size={23} color={color} />
            ),
          }}
        />
        <Drawer.Screen
          ...
          options={{
            drawerIcon: ({color}) => (
              <Dicon name="user-circle-o" size={23} color={color} />
            ),
          }}
        />
      </Drawer.Navigator>
